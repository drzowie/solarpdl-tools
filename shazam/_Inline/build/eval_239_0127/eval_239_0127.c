 ...
 * contents of eval_239_0127.xs. Do not edit this file, edit eval_239_0127.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "eval_239_0127.xs"
...
PDL_COMMENT("none")
 ...
 static char *__parnames[] = {"x","dat","xloc","c","out"};
		...
		static char __funcname[] = "eval_239_0127::my_cspline_irregular";
...
register PDL_Long __inc_x_k = __privtrans->__inc_x_k;
	...
	long dexhi;
       ...
       if(      (xloc_datap)[0] PDL_COMMENT("ACCESS()")  < (x_datap)[0+(__inc_x_k*PP_INDTERM(__privtrans->__k_size, 0))] PDL_COMMENT("ACCESS()")    ) {
	 (out_datap)[0] PDL_COMMENT("ACCESS()")  = asin(-1.1);

       } else if((xloc_datap)[0] PDL_COMMENT("ACCESS()")  > (x_datap)[0+(__inc_x_k*PP_INDTERM(__privtrans->__k_size, n-1))] PDL_COMMENT("ACCESS()") ) {
	 (out_datap)[0] PDL_COMMENT("ACCESS()")  = asin(-1.1);
       } else {
       ...
       dex = dexlo - 1;
       printf("val=%g, dex=%d, dexlo=%d, dexhi=%d\n",(float)((xloc_datap)[0] PDL_COMMENT("ACCESS()") ), dex,dexlo, dexhi);
	   ...
	   if(dex<0 || dex > n-1) {
	       ...
	       xp[i]  = (xloc_datap)[0] PDL_COMMENT("ACCESS()")  + i - 1.5;
	   } else {
	 ...
	 xp[0]--;
       ...
       {
	   double t = ((xloc_datap)[0] PDL_COMMENT("ACCESS()")  - xp[1]) / (xp[2]-xp[1]);
	   double t1 = 1 - t;
	   ...
	   (out_datap)[0] PDL_COMMENT("ACCESS()")  = h00 * p[1] + h10 * m0 * (xp[2]-xp[1]) + h01 * p[2] + h11 * m1 * (xp[2]-xp[1]);
       }
       } # end of else
...
#line 1599 "eval_239_0127.c"

XS(XS_eval_239_0127_set_debugging); /* prototype to pass -Wmissing-prototypes */
XS(XS_eval_239_0127_set_debugging)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 1545 "eval_239_0127.xs"
	RETVAL = __pdl_debugging;
	__pdl_debugging = i;
#line 1618 "eval_239_0127.c"
...
XS(XS_eval_239_0127_set_boundscheck); /* prototype to pass -Wmissing-prototypes */
XS(XS_eval_239_0127_set_boundscheck)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 1554 "eval_239_0127.xs"
       if (! 1)
         warn("Bounds checking is disabled for eval_239_0127");
       RETVAL = __pdl_boundscheck;
       __pdl_boundscheck = i;
#line 1644 "eval_239_0127.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 1568 "eval_239_0127.xs"
  ...
  pdl  *c;
  pdl  *out;
#line 1675 "eval_239_0127.c"
#line 1580 "eval_239_0127.xs"
{
  ...
  if (items == 5) { PDL_COMMENT("all variables on stack, read in output and temp vars")
    ...
    croak ("Usage:  PDL::my_cspline_irregular(x,dat,xloc,c,out) (you may leave temporaries or output variables out of list)");
  }
}
{
}
...
extern "C"
#endif
XS(boot_eval_239_0127); /* prototype to pass -Wmissing-prototypes */
XS(boot_eval_239_0127)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("eval_239_0127::set_debugging", XS_eval_239_0127_set_debugging, file, "$");
        (void)newXSproto_portable("eval_239_0127::set_boundscheck", XS_eval_239_0127_set_boundscheck, file, "$");
        (void)newXSproto_portable("PDL::my_cspline_irregular", XS_PDL_my_cspline_irregular, file, ";@");

    /* Initialisation Section */

#line 1693 "eval_239_0127.xs"
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "[PDL->Version: %d PDL_CORE_VERSION: %d XS_VERSION: %s] eval_239_0127 needs to be recompiled against the newly installed PDL", PDL->Version, PDL_CORE_VERSION, XS_VERSION);

#line 1835 "eval_239_0127.c"
