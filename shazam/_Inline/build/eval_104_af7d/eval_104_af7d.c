 ...
 * contents of eval_104_af7d.xs. Do not edit this file, edit eval_104_af7d.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "eval_104_af7d.xs"
...
PDL_COMMENT("none")
 ...
 static char *__parnames[] = {"x","dat","xloc","c","out"};
		...
		static char __funcname[] = "eval_104_af7d::my_cspline_irregular";
...
#line 1480 "eval_104_af7d.c"

XS(XS_eval_104_af7d_set_debugging); /* prototype to pass -Wmissing-prototypes */
XS(XS_eval_104_af7d_set_debugging)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 1426 "eval_104_af7d.xs"
	RETVAL = __pdl_debugging;
	__pdl_debugging = i;
#line 1499 "eval_104_af7d.c"
...
XS(XS_eval_104_af7d_set_boundscheck); /* prototype to pass -Wmissing-prototypes */
XS(XS_eval_104_af7d_set_boundscheck)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 1435 "eval_104_af7d.xs"
       if (! 1)
         warn("Bounds checking is disabled for eval_104_af7d");
       RETVAL = __pdl_boundscheck;
       __pdl_boundscheck = i;
#line 1525 "eval_104_af7d.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 1449 "eval_104_af7d.xs"
  ...
  pdl  *out;
  char  bound;
#line 1557 "eval_104_af7d.c"
#line 1462 "eval_104_af7d.xs"
{
...
extern "C"
#endif
XS(boot_eval_104_af7d); /* prototype to pass -Wmissing-prototypes */
XS(boot_eval_104_af7d)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("eval_104_af7d::set_debugging", XS_eval_104_af7d_set_debugging, file, "$");
        (void)newXSproto_portable("eval_104_af7d::set_boundscheck", XS_eval_104_af7d_set_boundscheck, file, "$");
        (void)newXSproto_portable("PDL::my_cspline_irregular", XS_PDL_my_cspline_irregular, file, ";@");

    /* Initialisation Section */

#line 1579 "eval_104_af7d.xs"
...
#define aTHX_
   ...
   if (PDL->Version != PDL_CORE_VERSION)
     Perl_croak(aTHX_ "[PDL->Version: %d PDL_CORE_VERSION: %d XS_VERSION: %s] eval_104_af7d needs to be recompiled against the newly installed PDL", PDL->Version, PDL_CORE_VERSION, XS_VERSION);

#line 1721 "eval_104_af7d.c"
